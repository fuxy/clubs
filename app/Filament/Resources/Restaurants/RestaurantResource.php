...
class RestaurantResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Ресторанти с детски кът';

    protected static ?string $modelLabel = 'Ресторант с детски кът';

    protected static ?string $pluralModelLabel = 'Ресторанти с детски кът';
