...
namespace App\Filament\Resources\DecoratingAgencies\Schemas;
                    ...
                    ->schema([
                        GoogleAutocomplete::make('google_search')
                            ...
                            ->withFields([
                                ...
                                TextInput::make('city')
                                    ->label('Град')
                                    ->afterStateHydrated(function (TextInput $component, ?DecoratingAgency $record) {
                                        if (! is_null($record)) {
